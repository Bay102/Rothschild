          ...
          <div className={`${styles.support} contentContainer`}>
            <div className="contentText">
              ...
              <p>
                ...
                that sets us apart from traditional trusts. Instead of solely relying
                on established trust funds, we actively engage in fundraising and
                form strategic alliances with individuals and organizations who share
                our goals and believe in our mission. Through planned and one-time
                giving, our partners play a pivotal role in the success of our
                incubator projects.
                <br />
                <br />
                This distinctive model enables us to remain adaptable and responsive
                to the ever-evolving realities and needs of the communities we serve.
                It empowers us to dynamically allocate resources where they are
                generating maximum impact. Our esteemed partners, from individuals to
                organizations, consciously decide to invest in creating better
                futures and become co-developers of change. Whether it's a one-time
                gift or a planned contribution, every donation propels us closer to
                our objectives, igniting innovation and driving sustainable and
                meaningful progress.
              </p>
          ...
          <div className={`contentContainer ${styles.marginOff}`}>
            ...
            <div className={`contentText ${styles.careersText}`}>
              ...
              <p>
                ...
                perspective and helping us steer our efforts toward the most
                promising, impactful initiatives.
                <br />
                <br />
