        ...
        <div className="contentContainer">
          ...
          <div className="contentText">
            ...
            <p>
              ...
              driven by their desire to share their culinary creativity with the
              community. Their journey began humbly with a Jewish deli,
              embodying the essence of tradition, quality, and community
              connection. Initially a local establishment, it delighted patrons
              with classic Jewish delicacies like corned beef and pastrami
              sandwiches, matzo ball soup, and hoagies. Through the years, its
              reputation grew through word-of-mouth and the unwavering
              excellence of its offerings, solidifying its place as a beloved
